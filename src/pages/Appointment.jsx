...
<div className="md:mt10  flex flex-col items-center lg:items-start lg:mx-48 md:px-0 sm:px-10 h-screen relative">
<div className="absolute left-4 top-3 md:hidden sm:block" onClick={handleOpen}><FaBarsStaggered /></div>
  ...
  <div className=" mt-12  flex lg:w-[600px] items-center lg:items-start flex-col">
    ...
    <div className="buttons my-2">
      <button className="border border-1 border-black rounded-[3px] px-2 py-1 my-2  mr-2 text-[.8rem]">change appointment</button>
      <button className="border border-1 bg-green text-white rounded-[3px] px-2 py-1 my-2  mr-2 text-[.8rem]"> Make an appointment</button>
    </div>
